    ...
    <>
      <ImagesSlider className="min-h-screen" images={images}>
        ...
        >
          ...
          <motion.div className="text-center text-neutral-50 md:text-xl">
            Be the first to know when Fantura goes live.
            <form className="flex space-x-2 pt-4">
              <Input
