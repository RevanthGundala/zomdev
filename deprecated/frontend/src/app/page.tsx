...
export default function Home() {
  ...
  const [
    zkLoginUserAddress,
    setZkLoginUsesetrAddress,
    removeZkLoginUserAddress,
  ] = useSessionStorage("zkLoginUserAddress", "");

  const [inputs, setInputs, removeInputs] = useSessionStorage("inputs", "");
  ...
  //       setZkLoginUsesetrAddress(zkLoginUserAddress);
  //       setInputs(inputs);
  //     } catch (e) {
  //       console.log("error: ", e);
  //     }
  ...
  return (
    <>
      ...
      {/* <motion.div
        ...
        animate={{
          backgroundColor: isInView1 || isInView2 ? "#000000" : "#FFFFFF",
        }}
      ...
      {/* <div className="h-30 mt-60 rounded-md flex flex-col antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
        <InfiniteMovingCards
          items={testimonials}
          direction="right"
          speed="slow"
      ...
      {/* <motion.div
        ...
        animate={{
          backgroundColor: isInView2 ? "#000000" : "#FFFFFF",
        }}
        transition={{ duration: 1 }}
        ref={section2}
        className="min-h-screen"
      ...
      <div className="mb-40">
        <AnimatePresence initial={false}>
          <motion.img
            ...
            src={creators[current]}
            key={creators[current]}
            alt=""
            className="rounded-lg lg:h-200 lg:w-200 object-scale-down absolute"
          />
        </AnimatePresence>
      </div>
    </>
